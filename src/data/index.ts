...
export const programs: Program[] = [
  ...
  },
  {
    ...
    summary:
      "Love Volunteers places ESL volunteers in public schools and community English programs in Hanoi. As a nonprofit, Love Volunteers keeps fees low while maintaining vetted, supported placements. Housing in shared volunteer accommodation is included.",
    highlights: [
      "Nonprofit with low program fees",
      "Flexible year-round start dates",
      "Placement in Hanoi's local schools",
      "Shared volunteer housing included",
      "18+ with no degree required",
    ],
    websiteUrl: "https://www.lovevolunteers.org/destinations/volunteer-vietnam/teaching-english-hanoi",
    applicationUrl: null,
    contactEmail: null,
  },
  // ---- THAILAND ----
